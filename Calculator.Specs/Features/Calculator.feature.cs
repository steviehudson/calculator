...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("Subtract first number from second number", new string[] {
                "subtract"}, SourceLine=15)]
        public virtual void SubtractFirstNumberFromSecondNumber()
        {
            string[] tagsOfScenario = new string[] {
                    "subtract"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Subtract first number from second number", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 16
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
...
#line hidden
#line 19
 testRunner.When("the first number is subtracted from the second number", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 20
